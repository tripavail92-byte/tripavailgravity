  ...
  return (
    ...
    >
      ...
      <motion.g initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ duration: 0.5 }}>
        ...
        />
        <path
          d="M25 34 C25 31.7909 26.7909 30 29 30 H91 C93.2091 30 95 31.7909 95 34 V45 H25 V34 Z"
          fill="url(#weekHeader)"
        />
        {/* Rings */}
      ...
      >
        ...
        />
        <path
          d="M85 75 V70 C85 68 87 66 90 66 H90 C93 66 95 68 95 70 V75"
          stroke="#C2410C"
          strokeWidth="2"
          fill="none"
        />
