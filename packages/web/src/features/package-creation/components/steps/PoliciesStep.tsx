...
const CANCELLATION_POLICIES = [
    {
        ...
        refundSchedule: '100% refund if cancelled 24+ hours before • 0% refund if cancelled within 24 hours'
    },
    {
        id: 'moderate',
        name: 'Moderate',
        description: 'Free cancellation up to 7 days before start',
        refundSchedule: '100% refund if cancelled 7+ days before • 50% refund if cancelled 3-7 days before • 0% refund if cancelled within 3 days'
    },
    {
        id: 'strict',
        name: 'Strict',
        description: 'No refunds after booking',
        refundSchedule: '100% refund if cancelled within 24 hours of booking • 0% refund after 24 hours'
    },
    {
        id: 'custom',
        name: 'Custom Policy',
...
const PAYMENT_TERMS = [
    ...
    { id: 'deposit', name: 'Deposit Required', description: '30% deposit at booking, balance before trip' },
...
export function PoliciesStep({ onComplete, onUpdate, existingData, onBack }: PoliciesStepProps) {
    ...
    const [paymentTerms, setPaymentTerms] = useState(
        (existingData?.paymentTerms as string) || 'full'
    );
    ...
    const handleContinue = () => {
        onComplete({
            cancellationPolicy,
            customCancellationPolicy: cancellationPolicy === 'custom' ? customCancellationPolicy : undefined,
            paymentTerms,
            termsAndConditions
        });
    };
        ...
        <div className="max-w-4xl mx-auto space-y-6">
            ...
            <Card className="p-6">
                ...
                {cancellationPolicy === 'custom' && (
                    <div className="mt-4">
                        <Label htmlFor="customPolicy" className="mb-2 block">Custom Cancellation Policy</Label>
                        <Textarea
                            id="customPolicy"
            ...
            <Card className="p-6">
                ...
                <div className="bg-info/5 border border-info/20 rounded-lg p-3 mb-4 flex items-start gap-2">
                    ...
                    <p className="text-sm text-gray-700">
                        Include important details like age restrictions, health requirements, required documents, etc.
                    </p>
                </div>
                <Textarea
