...
export function HotelSelectionStep({ onComplete, onUpdate, existingData }: HotelSelectionStepProps) {
            ...
            <Card className="p-4 bg-info/5 border-info/20">
                <div className="flex items-start gap-3">
                    ...
                    <div className="text-sm text-gray-700">
                        ...
                        <p>Each package is linked to a specific hotel. Room prices and availability will be fetched from the selected hotel.</p>
                    </div>
                </div>
            </Card>
                                ...
                                <div className="flex-1">
                                    ...
                                    {hotel.roomCount !== undefined && (
                                        <p className="text-sm text-gray-600">
                                            <strong>{hotel.roomCount}</strong> room type{hotel.roomCount !== 1 ? 's' : ''} available
                                        </p>
                                    )}
                                </div>
                            </div>
