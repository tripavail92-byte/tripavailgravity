...
export function ListingCard({
  ...
  return (
    <GlassCard
      variant="card"
      className="overflow-hidden rounded-2xl hover:shadow-lg transition-shadow duration-200 group"
    >
      {/* Image */}
      <div className="relative h-48 bg-gradient-to-br from-gray-200 to-gray-300">
        ...
        <GlassBadge
          variant="light"
          className={`absolute top-3 left-3 flex items-center gap-1 ${config.color}`}
        >
