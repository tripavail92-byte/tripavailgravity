    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <h3 className="text-sm font-bold text-amber-900">You have {drafts.length} unpublished tour drafts</h3>
            ...
            <Button size="sm" className="bg-amber-600 hover:bg-amber-700 text-white border-none shadow-sm shadow-amber-200 whitespace-nowrap">
                Resume Setup
            </Button>
        </motion.div>
    );
