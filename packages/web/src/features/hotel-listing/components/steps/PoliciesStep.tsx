        ...
        <div className="space-y-4">
          <div>
            ...
            <Input
              ...
              onChange={(e) =>
                handleGuestRequirementsUpdate({ minimumAge: parseInt(e.target.value) || 0 })
              }
              className="max-w-xs"
            />
          </div>
            ...
            {[
              {
                ...
                description: 'Guests must verify their identity',
              },
              {
                key: 'creditCardRequired',
                label: 'Credit Card Required',
                description: 'Valid credit card needed for booking',
              },
              ...
              >
                <input
                  type="checkbox"
                  checked={
                    policies.guestRequirements[
                      key as keyof typeof policies.guestRequirements
                    ] as boolean
                  }
