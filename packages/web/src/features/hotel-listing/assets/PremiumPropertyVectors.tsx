    ...
    case 'resort':
      return (
        ...
        >
          ...
          <motion.path
            d="M 40 38 Q 50 36 60 38 Q 70 40 80 38"
            stroke="#0EA5E9"
            strokeWidth="2"
            fill="none"
          ...
          >
            ...
            <motion.path
              d="M 28 75 Q 18 65 20 60 M 28 75 Q 23 63 26 58 M 28 75 Q 33 63 30 58 M 28 75 Q 38 65 36 60"
              stroke="url(#palm)"
              strokeWidth="3"
              strokeLinecap="round"
              fill="none"
            ...
            <motion.path
              d="M 92 78 Q 82 70 84 66 M 92 78 Q 87 68 90 64 M 92 78 Q 97 68 94 64 M 92 78 Q 102 70 100 66"
              stroke="url(#palm)"
              strokeWidth="3"
              strokeLinecap="round"
              fill="none"
          ...
          />
          <motion.path
            d="M 90 18 L 92 22 L 96 22 L 93 25 L 94 29 L 90 26 L 86 29 L 87 25 L 84 22 L 88 22 Z"
            fill="#F59E0B"
            animate={{ rotate: 360 }}
    ...
    case 'boutique':
      return (
        ...
        >
          ...
          <motion.path
            d="M 35 100 L 35 40 Q 35 28 45 28 L 75 28 Q 85 28 85 40 L 85 100 Z"
            fill="url(#boutiqueBldg)"
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
          ...
          <motion.path
            d="M 50 78 Q 60 70 70 78 L 70 100 L 50 100 Z"
            fill="#1F2937"
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
          ...
          <motion.path
            d="M 38 28 L 43 18 L 50 23 L 57 15 L 60 23 L 63 15 L 70 23 L 77 18 L 82 28"
            stroke="url(#boutiqueAccent)"
            strokeWidth="3"
            strokeLinecap="round"
    ...
    case 'lodge':
      return (
        ...
        >
          ...
          <motion.path
            d="M 25 50 L 60 20 L 95 50 L 85 50 L 60 27 L 35 50 Z"
            fill="url(#lodgeRoof)"
            initial={{ y: -20 }}
            animate={{ y: 0 }}
          ...
          <motion.path
            d="M 75 28 Q 72 22 74 18 M 76 26 Q 79 20 77 16"
            stroke="#9CA3AF"
            strokeWidth="2"
            strokeLinecap="round"
            fill="none"
    ...
    case 'inn':
      return (
        ...
        >
          ...
          <motion.path
            d="M 28 55 L 60 30 L 92 55 L 85 55 L 60 38 L 35 55 Z"
            fill="#7C2D12"
            initial={{ y: -20 }}
            animate={{ y: 0 }}
          ...
          <motion.path
            d="M 53 88 Q 60 82 67 88 L 67 105 L 53 105 Z"
            fill="#1F2937"
            rx="2"
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
    ...
    case 'guesthouse':
      return (
        ...
        >
          ...
          <motion.path
            d="M 20 105 L 20 50 L 60 20 L 100 50 L 100 105 Z"
            fill="url(#houseBldg)"
            initial={{ scaleY: 0 }}
            animate={{ scaleY: 1 }}
            transition={{ duration: 0.7 }}
          ...
          <motion.path
            d="M 15 50 L 60 15 L 105 50 L 100 50 L 60 20 L 20 50 Z"
            fill="url(#houseRoof)"
            initial={{ y: -20 }}
            animate={{ y: 0 }}
            transition={{ delay: 0.2, type: 'spring' }}
      ...
      return (
        ...
        >
          ...
          >
            ...
            <text x="78" y="26" textAnchor="middle" fontSize="14" fontWeight="bold" fill="white">
              $
            </text>
          </motion.g>
