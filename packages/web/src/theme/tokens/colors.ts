...
export const colorTokens = {
  ...
  dark: {
    background: {
      ...
      surface: '0 0% 5%',             // Card backgrounds
      overlay: '0 0% 0% / 0.8',       // Modal overlay (80% black)
      hover: '0 0% 10%',              // Hover states
    },
    foreground: {
      primary: '0 0% 100%',           // Pure white (text)
      secondary: '215 20.2% 65.1%',   // Medium gray
      tertiary: '215.4 16.3% 46.9%',  // Darker gray
      disabled: '217.2 32.6% 17.5%',  // Very dark gray
    },
    border: {
      primary: '217.2 32.6% 17.5%',   // Dark gray border
