...
export const dictionaries: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'hero.defaultSub':
      'Curated tours, romantic escapes & family getaways — transparent pricing, instant confirmation.',
    'hero.popularInEyebrow': 'Popular in {country}',
    'hero.discoverTitle': 'Discover {country}.',
    'hero.discoverSub':
      'Handpicked tours & experiences across {country} — transparent pricing, instant confirmation.',
    'hero.comingSoonEyebrow': 'Coming soon to {country}',
    'hero.expandingTitle': "We're expanding to {country}.",
    'hero.expandingSub':
      'Verified tours are on their way to {country}. In the meantime, explore top experiences worldwide.',
    ...
    'search.popular': 'Popular filters',
    'search.topRatedFilter': 'Top rated · 4.5★ & up',
  ...
  ar: {
    ...
    'hero.defaultSub': 'جولات مختارة، رحلات رومانسية وعائلية — أسعار شفافة وتأكيد فوري.',
    'hero.popularInEyebrow': 'الأكثر رواجاً في {country}',
    'hero.discoverTitle': 'اكتشف {country}.',
    'hero.discoverSub': 'جولات وتجارب مختارة بعناية في {country} — أسعار شفافة وتأكيد فوري.',
    'hero.comingSoonEyebrow': 'قريباً في {country}',
    'hero.expandingTitle': 'نتوسّع قريباً إلى {country}.',
    'hero.expandingSub':
      'جولات موثّقة في طريقها إلى {country}. وبانتظار ذلك، استكشف أفضل التجارب حول العالم.',
    ...
    'search.popular': 'عوامل التصفية الشائعة',
    'search.topRatedFilter': 'الأعلى تقييماً · 4.5★ فأكثر',
