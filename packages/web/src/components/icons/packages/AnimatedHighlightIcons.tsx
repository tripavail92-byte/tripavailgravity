...
export const DumbbellIcon = ({
  ...
  >
    ...
    {colored && (
      ...
      >
        {/* Head */}
        <motion.circle cx="38" cy="20" r="4" fill="#fbbf24" stroke="#f59e0b" strokeWidth="1.5" />
        ...
        {/* Body */}
        <motion.path d="M38 24 L38 34" stroke="#ec4899" strokeWidth="3" strokeLinecap="round" />
        ...
        <motion.path
          ...
          strokeLinecap="round"
          animate={{
            d: ['M38 26 L34 30', 'M38 26 L36 32', 'M38 26 L34 30'],
            transition: {
              duration: 0.8,
              repeat: Infinity,
              ease: 'easeInOut',
        ...
        <motion.path
          ...
          strokeLinecap="round"
          animate={{
            d: ['M38 26 L42 32', 'M38 26 L40 30', 'M38 26 L42 32'],
            transition: {
              duration: 0.8,
              repeat: Infinity,
              ease: 'easeInOut',
...
export const getIconForHighlight = (name: string): React.ComponentType<AnimatedIconProps> => {
  ...
  if (normalized.includes('gym') || normalized.includes('fitness') || normalized.includes('train'))
    return DumbbellIcon
  if (normalized.includes('upgrade') || normalized.includes('room')) return UpgradeIcon
  if (normalized.includes('late') || normalized.includes('early') || normalized.includes('check'))
