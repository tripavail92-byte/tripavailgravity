...
export function Modern3DHotelIcon({
  className = '',
  size = 48,
  isSelected = false,
}: Modern3DHotelIconProps) {
    ...
    >
      ...
      >
        ...
        {isLit && (
          ...
          >
            {/* Ambient glow */}
            <circle cx="24" cy="24" r="22" fill="url(#ambientGlow)" opacity="0.4" />
            {/* Building highlight */}
            <rect
              x="13"
              y="11"
        ...
        >
          ...
          <path d="M32 34 L34 32 L34 18 L32 20 Z" fill="url(#buildingSide)" />
          ...
          <path d="M28 20 L30 18 L30 10 L28 12 Z" fill="url(#topSectionSide)" />

          {/* Rooftop */}
          <path d="M18 10 L26 10 L28 8 L16 8 Z" fill="url(#rooftop)" />
        </motion.g>
        ...
        >
          {/* Door */}
          <rect x="21" y="34" width="4" height="5" fill="url(#entrance)" rx="2" />
          {isLit && (
            <motion.rect
              x="20"
              y="33"
