...
export function TourPricingStep({ data, onUpdate, onNext, onBack }: TourPricingStepProps) {
 ...
 "      </div>`n$(import { DollarSign, Info, Percent, Plus, Trash2, Users } from 'lucide-react'
import { AnimatePresence, motion } from 'motion/react'
import { useState } from 'react'
    ...
    <div className="space-y-6">
      ...
      <div className="glass-card rounded-2xl p-6">
        <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
          <DollarSign className="w-5 h-5 text-emerald-500" /> Base Pricing
        </h3>
...
.Groups[1].Value)" Group Discounts */}
      <div className="glass-card rounded-2xl p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold flex items-center gap-2">
...
.Groups[1].Value)" Seasonal Pricing */}
      <div className="glass-card rounded-2xl p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold flex items-center gap-2">
...
.Groups[1].Value)" Inclusions & Exclusions */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="glass-card rounded-2xl p-6">
          <h3 className="text-sm font-bold text-success-dark mb-4 uppercase tracking-wider">
            What's Included
