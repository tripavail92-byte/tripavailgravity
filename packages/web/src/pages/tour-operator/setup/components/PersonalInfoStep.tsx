...
export function PersonalInfoStep({ onUpdate, data }: StepProps) {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h3 className="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">Personal Information</h3>
                <p className="text-lg text-gray-500 leading-relaxed font-medium">Let's start with your basic contact information.</p>
            </div>

            <Card className="p-8 space-y-6 border-gray-100 shadow-sm rounded-[32px] bg-white ring-1 ring-black/[0.02]">
                <div className="space-y-3">
                    <Label htmlFor="operatorName" className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">
                        Tour Operator Name *
                    </Label>
                    <Input
                        id="operatorName"
                ...
                <div className="space-y-3">
                    <Label htmlFor="contactPerson" className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">
