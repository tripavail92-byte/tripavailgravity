      ...
      <div className="space-y-6 p-6 rounded-2xl bg-muted/30 border border-border/50">
        ...
        <div className="space-y-3">
          ...
          <div className="relative">
            ...
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-1.5 bg-success/10 border border-success/30 rounded-lg px-2.5 py-1.5">
              <CheckCircle2 className="w-3.5 h-3.5 text-success" />
              <span className="text-[11px] font-bold text-success uppercase tracking-wide">Verified</span>
            </div>
          </div>
        ...
        <div className="space-y-3">
          ...
          {phoneVerified && !phoneChanged ? (
            <div className="flex items-center gap-2 p-3 rounded-xl bg-success/10 border border-success/30">
              ...
              <span className="text-sm font-bold text-success">Phone Verified</span>
              <span className="text-xs text-success/70 font-medium truncate ml-auto">{verifiedPhone}</span>
            </div>
          ) : (
            <div className="rounded-xl border border-destructive/30 bg-destructive/5 overflow-hidden">
              <div className="flex items-center justify-between gap-3 p-3">
                <div className="flex items-center gap-2">
                  {phoneChanged ? (
                    <><XCircle className="w-4 h-4 text-warning shrink-0" /><span className="text-sm font-bold text-warning">Phone changed — re-verify</span></>
                  ) : (
                    <><XCircle className="w-4 h-4 text-destructive shrink-0" /><span className="text-sm font-bold text-destructive">Not Verified</span></>
                  )}
                </div>
                <Button size="sm" variant="outline"
                  className="rounded-xl border-success/50 text-success hover:bg-success/10 font-bold gap-1.5 shrink-0"
              ...
              {(otpStage === 'sent' || otpStage === 'verifying') && (
                <div className="border-t border-destructive/20 bg-background/50 p-4 space-y-4">
                  <div className="text-center">
                    ...
                    {devOtp && (
                      <p className="text-xs font-black text-warning bg-warning/10 rounded-lg px-3 py-2 mt-2 border border-warning/30">
