    ...
    <div className="space-y-12">
      ...
      <section className="space-y-6">
        ...
        <div className="space-y-4">
          {PLATFORM_TERMS.map((term) => (
            <div
              key={term.id}
              className="border border-border/50 rounded-2xl overflow-hidden bg-muted/30 transition-all hover:bg-muted/40"
            >
              <button
              ...
              >
                <div className="flex items-center gap-5">
                  ...
                  <div className="text-left">
                    <p className="font-bold text-foreground tracking-tight">{term.title}</p>
                    <p className="text-xs text-muted-foreground/70 font-bold uppercase tracking-widest">
                      {term.desc}
                    </p>
                  </div>
                </div>
              ...
              <AnimatePresence>
                {expanded === term.id && (
                  ...
                  >
                    <div className="p-8 text-sm text-muted-foreground space-y-4 leading-relaxed bg-muted/20 font-medium">
                      <p>
        ...
        >
          <div
            className={cn(
              ...
              accepted
                ...
                : 'border-border/50 text-transparent group-hover:border-primary/40',
            )}
          >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground/70 font-bold uppercase tracking-widest leading-none mt-1">
      ...
      <section className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6">
          ...
          <div className="flex bg-muted border border-border/50 p-1 rounded-xl w-fit">
            <button
              onClick={() => {
        ...
        {policyMode === 'templates' ? (
              ...
              <div key={policy.id} className="space-y-4">
                ...
                <div className="relative group">
                  <Textarea
                    ...
                    className="min-h-[160px] rounded-2xl border-border/60 bg-background focus:border-primary/40 focus:ring-primary/15 transition-all resize-none text-base p-6 font-medium leading-relaxed"
                  />
                  {customPolicies[policy.id] && (
                    <button
                      onClick={() => handlePolicyChange(policy.id, '')}
                      className="absolute top-4 right-4 p-2 bg-muted backdrop-blur shadow-lg rounded-xl opacity-0 group-hover:opacity-100 transition-all hover:bg-destructive/10 hover:text-destructive border border-border/50"
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="p-12 border-2 border-dashed border-border/50 rounded-3xl bg-muted/30 flex flex-col items-center justify-center text-center group hover:border-primary/30 hover:bg-primary/[0.03] transition-all duration-500">
              ...
              <h5 className="text-lg font-black text-foreground mb-2 uppercase tracking-tighter">
