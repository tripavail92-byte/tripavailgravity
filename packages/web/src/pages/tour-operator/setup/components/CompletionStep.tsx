        ...
        <div className="flex flex-col items-center">
            <Card className="p-10 text-center border-none shadow-none bg-transparent flex flex-col items-center">
                ...
                <motion.div
                    ...
                    className="space-y-4"
                >
                    <h2 className="text-4xl font-black text-gray-900 tracking-tighter uppercase italic">You're All Set!</h2>
                    <p className="text-xl text-gray-500 max-w-md mx-auto leading-relaxed font-medium">
                        Your operator profile is now complete. Our team will review your verification documents shortly.
                    </p>
