...
export function BusinessInfoStep({ onUpdate, data }: StepProps) {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h3 className="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight">Business Details</h3>
                <p className="text-lg text-gray-500 leading-relaxed font-medium">Tell travelers about your tour business operation.</p>
            </div>
            ...
            <Card className="p-8 space-y-8 border-gray-100 shadow-sm rounded-[32px] bg-white ring-1 ring-black/[0.02]">
                    ...
                    <div className="flex items-center gap-6 p-6 border-2 border-dashed border-gray-100 rounded-2xl bg-gray-50/50 transition-colors hover:bg-gray-50/80">
                        <div className="w-24 h-24 bg-white rounded-2xl flex items-center justify-center overflow-hidden border border-gray-100 flex-shrink-0 shadow-sm">
                            {isUploading ? (
                                ...
                                <img src={formData.companyLogo} alt="Business Logo" className="w-full h-full object-contain" />
                            ) : (
                        ...
                        <div className="flex-1 space-y-3">
                            ...
                            >
                                {isUploading ? <Loader2 className="w-4 h-4 animate-spin" /> : <Upload className="w-4 h-4" aria-hidden="true" />}
                ...
                <div className="space-y-3">
                    <Label htmlFor="businessName" className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-3">
                        <Label className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">Experience</Label>
                        <Select
                        ...
                        >
                            ...
                            <SelectContent className="rounded-2xl border-gray-100 shadow-xl overflow-hidden p-1">
                                <SelectItem value="lt-1" className="rounded-xl px-4 py-2.5">New Operation</SelectItem>
                                <SelectItem value="1-3" className="rounded-xl px-4 py-2.5">1-3 years</SelectItem>
                                <SelectItem value="3-5" className="rounded-xl px-4 py-2.5">3-5 years</SelectItem>
                                <SelectItem value="5-plus" className="rounded-xl px-4 py-2.5">5+ years</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                    <div className="space-y-3">
                        <Label className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">Team Size</Label>
                        <Select
                        ...
                        >
                            ...
                            <SelectContent className="rounded-2xl border-gray-100 shadow-xl overflow-hidden p-1">
                                <SelectItem value="1" className="rounded-xl px-4 py-2.5">Solo Operator</SelectItem>
                                <SelectItem value="2-5" className="rounded-xl px-4 py-2.5">2-5 staff</SelectItem>
                                <SelectItem value="6-15" className="rounded-xl px-4 py-2.5">6-15 staff</SelectItem>
                                <SelectItem value="15-plus" className="rounded-xl px-4 py-2.5">15+ staff</SelectItem>
                            </SelectContent>
                        </Select>
                    </div>
                </div>
                ...
                <div className="space-y-3">
                    <Label htmlFor="description" className="text-xs font-bold uppercase tracking-widest text-gray-500 ml-1">
