...
export default function BookingConfirmationPage() {
    ...
    const [confirmationStatus, setConfirmationStatus] = useState<'confirming' | 'success' | 'error'>('confirming');
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 min-h-screen pb-20">
            ...
            <div className="bg-white border-b border-gray-100">
                <div className="max-w-2xl mx-auto px-4 py-8 text-center">
                    ...
                    <p className="text-lg text-gray-600 font-medium">Your tour is booked. Get ready for an amazing adventure!</p>
                </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto px-4 py-8">
                ...
                >
                    ...
                    <div className="text-center p-6 bg-primary/5 rounded-xl border border-primary/20">
                        <p className="text-sm text-gray-600 font-medium uppercase tracking-widest mb-2">Confirmation Number</p>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3 p-4 bg-gray-50 rounded-xl">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span className="text-gray-900 font-bold">{tour.location.city}, {tour.location.country}</span>
                                </div>
                                <div className="h-px bg-gray-200" />
                                <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-3 p-4 bg-blue-50 rounded-xl border border-blue-200">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <p className="text-xs text-blue-600 font-bold uppercase tracking-widest">Departure</p>
                                ...
                                <div className="flex items-center gap-2">
                                    <Calendar className="w-5 h-5 text-blue-600" />
                                    <div>
                                        <p className="text-xs text-blue-600 font-bold uppercase tracking-widest">Return</p>
                                        <p className="text-gray-900 font-bold">
