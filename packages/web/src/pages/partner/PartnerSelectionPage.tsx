...
export default function PartnerSelectionPage() {
    ...
    const handleSelectPartner = async (mode: 'hotel_manager' | 'tour_operator') => {
        ...
        if (activeRole?.role_type !== 'traveller') {
            alert(`You have already selected ${activeRole?.role_type}. Partner role selection is permanent.`);
            return;
        }
            ...
            <div className="w-full max-w-5xl">
                ...
                <div className="text-center mb-12">
                    ...
                    {activeRole?.role_type !== 'traveller' && (
                        <p className="mt-4 text-amber-600 font-medium">⚠️ You have already selected a partner role. This choice is permanent.</p>
                    )}
                </div>
