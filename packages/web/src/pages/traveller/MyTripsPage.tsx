              ...
              {displayedTrips.map((trip, idx) => {
                ...
                return (
                  ...
                  >
                    <GlassCard
                      variant="card"
                      className="p-0 overflow-hidden rounded-3xl group border-none shadow-sm hover:shadow-xl transition-all duration-500"
                    >
                      <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-64 h-48 md:h-auto relative overflow-hidden">
                          ...
                          <div className="absolute top-4 left-4">
                            <Badge
                              className={`backdrop-blur-md border-none px-3 py-1 font-bold text-[10px] uppercase tracking-wider ${getStatusColor(trip.status)}`}
                            >
                              {trip.status}
                            </Badge>
                          </div>
