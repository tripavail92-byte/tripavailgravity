    ...
    if (!tour) {
        return (
            <div className="min-h-screen flex flex-col items-center justify-center p-4">
                ...
                <Button onClick={() => navigate('/')} variant="default" className="rounded-2xl px-8 h-12 font-bold">
                    Back to Homepage
                </Button>
            </div>
        );
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 h-[400px] md:h-[500px]">
                    <div className="md:col-span-2 rounded-3xl overflow-hidden shadow-xl">
                        <img
                            src={tour.images?.[0] || 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=1200'}
                            alt={tour.title}
                    ...
                    <div className="hidden md:flex flex-col gap-4">
                        <div className="flex-1 rounded-3xl overflow-hidden shadow-lg">
                            <img
                                src={tour.images?.[1] || 'https://images.unsplash.com/photo-1512100356956-c122ecc598a8?w=800'}
                                alt="Tour detail 1"
                        ...
                        <div className="flex-1 rounded-3xl overflow-hidden shadow-lg relative cursor-pointer group">
                            <img
                                src={tour.images?.[2] || 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800'}
                                alt="Tour detail 2"
                                className="w-full h-full object-cover"
                            />
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <ul className="space-y-3">
                                                {tour.exclusions.map((exc, i) => (
                                                    <li key={i} className="flex items-center gap-3 text-gray-400 font-medium line-through">
                            ...
                            {activeTab === 'itinerary' && (
                                ...
                                >
                                    {tour.itinerary?.map((day: any, idx: number) => (
                                        <div key={idx} className="relative pl-10 pb-8 last:pb-0 border-l-2 border-gray-100 last:border-transparent">
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <Badge variant="outline" className="border-gray-200 text-gray-500">{day.activities?.length || 0} Activities</Badge>
                                                </div>
                                                <div className="grid grid-cols-1 gap-4">
                                                    {day.activities?.map((act: any, ai: number) => (
                                                        <div key={ai} className="bg-white border border-gray-100 p-4 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <div className="lg:col-span-1">
                        <div className="sticky top-24 space-y-6">
                                ...
                                <div className="flex items-baseline justify-between">
                                    <div className="space-y-1">
                                        ...
                                        <div className="flex items-baseline gap-1">
                                            <span className="text-3xl font-black text-gray-900">{tour.currency} {tour.price}</span>
                            ...
                            <div className="bg-gray-900 rounded-[2rem] p-6 text-white flex items-center gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-[10px] font-bold text-white/50 uppercase tracking-widest">Hosted by</p>
                                    <h6 className="font-bold truncate">Premium Tour Operator</h6>
                                </div>
                                <Button variant="ghost" size="sm" className="text-primary font-bold hover:bg-white/10 p-0 h-auto">
                                    Contact
                                </Button>
                            </div>
                        </div>
