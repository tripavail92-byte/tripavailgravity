            ...
            <AnimatePresence mode="wait">
                {subStep === 'id_upload' && (
                    ...
                    >
                        ...
                        <Card className={cn(
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center", idCardUrl ? "bg-green-100 text-green-600" : "bg-white text-gray-400")}>
                                ...
                                <div>
                                    ...
                                    />
                                    <Button asChild variant={idCardUrl ? "outline" : "default"} className={cn("rounded-xl", idCardUrl && "border-green-200 text-green-700 hover:bg-green-100")}>
                                        <label htmlFor="id-front-upload" className="cursor-pointer">
                                            {isUploadingFront ? <Loader2 className="animate-spin w-4 h-4" /> : (idCardUrl ? "Change" : "Upload")}
                                        </label>
                                    </Button>
                                </div>
                            </div>
                        ...
                        <Card className={cn(
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center", idBackUrl ? "bg-green-100 text-green-600" : "bg-white text-gray-400")}>
                                ...
                                <div>
                                    ...
                                    />
                                    <Button asChild variant={idBackUrl ? "outline" : "default"} className={cn("rounded-xl", idBackUrl && "border-green-200 text-green-700 hover:bg-green-100")}>
                                        <label htmlFor="id-back-upload" className="cursor-pointer">
                                            {isUploadingBack ? <Loader2 className="animate-spin w-4 h-4" /> : (idBackUrl ? "Change" : "Upload")}
                                        </label>
                                    </Button>
                                </div>
                            </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="p-3 bg-green-50 rounded-2xl flex flex-col items-center text-center space-y-2">
                                ...
                                <p className="text-[10px] font-black uppercase text-green-700 tracking-widest">ID Visible</p>
                            </div>
                        </div>
                        ...
                        <Card className="p-8 border-2 border-dashed border-gray-100 flex flex-col items-center justify-center bg-gray-50/50 rounded-[32px]">
                            ...
                            />
                            <Button asChild className="rounded-2xl px-8 h-12 bg-primary-gradient text-white font-black uppercase tracking-widest border-0 shadow-lg shadow-primary/20">
                                <label htmlFor="selfie-upload" className="cursor-pointer">
                                    {isUploadingSelfie ? <Loader2 className="animate-spin mr-2" /> : <Camera className="mr-2" />}
                                    Take Selfie
                                </label>
                            </Button>
                        </Card>
                        <button onClick={() => setSubStep('id_upload')} className="w-full text-center text-xs font-bold text-gray-400 uppercase tracking-widest hover:text-primary">← Go Back</button>
                    </motion.div>
                )}
                ...
                {subStep === 'verifying' && (
                    ...
                    >
                        ...
                        <h4 className="text-2xl font-black text-gray-900 tracking-tight italic uppercase">Verifying Identity</h4>
