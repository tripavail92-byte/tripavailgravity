    ...
    return (
        <div className="flex flex-col items-center py-6 space-y-12">
            ...
            <div className="grid grid-cols-1 gap-4 w-full">
                {[
                    { icon: ShieldCheck, title: "Verified Trust", text: "Gain the trusted badge for your property" },
                    { icon: BadgePercent, title: "Direct Bookings", text: "Zero commission on your first 10 bookings" },
                ].map((item, i) => (
                    <motion.div
                        key={i}
